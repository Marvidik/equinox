      ...
      <main className={styles.mainArea}>
        ...
        <header className={styles.header}>
          ...
          <div className={styles.headerRight}>
            ...
            <Link href="/dashboard/kyc" className={styles.profile}>
              <div className={styles.profileInfo}>
                <span className={styles.profileName}>Jeff Scholite</span>
                <span className={styles.profileEmail}>jeffscholite@gmail.com</span>
              </div>
